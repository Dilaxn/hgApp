                ...
                renderTabBar={props => (
                    <TabBar
                        ...
                        renderLabel={({ route, color, fontFamily, fontSize }) => (
                            <Text style={[css.blackC, css.f14, css.fr, color]}>{route.title}</Text>
                        )}
                        activeColor={[css.brandC, css.fbo, css.f14]}
                        inactiveColor={[css.blackC, css.fbo, css.f14,]}
                        labelStyle={[css.brandC, css.fbo, css.f14]}
