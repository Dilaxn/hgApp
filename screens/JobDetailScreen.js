...
export default function JobDetailScreen({ route, props, navigation }) {
    ...
    const redirect = route.params.redirect ? route.params.redirect : false
    ...
    useFocusEffect(
        useCallback(async () => {
            const loadJobdetails = async () => {
                ...
                if (jD.driverData) {
                    await dispatch(loadGenie(jD.driverData._id));
                }
        ...
        <>
            {!jobdetailsData ?
                ...
                <View style={[styles.screen]}>
                            ...
                            <View style={[css.container, css.liteBlueBG, styles.fixedHeader, css.line, css.paddingB10, css.paddingT10]}>
                                <View style={[css.flexDR]}>
                                    {redirect === 'MyBookings' ?
                                        ...
                                        ><AntDesign style={[css.marginR10]} name="arrowleft" size={wp('5%')} color="#525252" />
                                        </Pressable>
                                        :
                                        <Pressable
                                            onPress={() => navigation.goBack()}
                                ...
                                <View style={[css.flexDC,]}>
                                    <View>
                                        <Text style={[css.fr, css.greyC, css.f12,]}>Booking For:{
                                            ...
                                            <View style={[styles.genieAssigned, css.borderGrey1, css.borderRadius10, css.imgFull]}>
                                                <View style={[css.flexDR, styles.genieHeader, css.padding20]}>
                                                    <View style={[css.flexDC, css.marginR20, css.width30]}>
                                                        {jobdetailsData.driverData.profilePicURL.original != '../img/genieicon.png' ?
                                                            <Image style={[styles.genieLogo, css.imgg90, css.borderBlack1, { borderRadius: 50, backgroundColor: 'grey' }]} source={{ uri: jobdetailsData.driverData.profilePicURL.original }} />
                                                            :
                                                            <Image style={[styles.genieLogo, css.imgg90, { borderRadius: 50, }]} source={require(imgPath + 'homegenie-logo.png')} />
                                                        }
                                    ...
                                    {jobdetailsData &&
                                        <View>
                                            <List.Accordion title="Booking Summary" id="1"
                                                ...
                                                style={[css.padding10, css.BGwhite, { paddingHorizontal: 0 }]}
                                            ...
                                            >
                                                ...
                                                <View>
                                                    <View style={[css.flexDRSB]}>
                                                        ...
                                                        >
                                                            ...
                                                            <Text style={[css.alignSelfC, css.blackC, css.fm, css.f12, css.marginL5]}>
                                                ...
                                                {jobdetailsData && jobdetailsData.materialImages.length && jobdetailsData.status != 'SETTLED' ?
                                                    <View>
                                                        <FlatList
                                            ...
                                            <List.Accordion title="Payment Summary" id="2"
                                                titleStyle={[css.blackC, css.fsb, css.f14]}
                                                style={[css.BGwhite, css.padding10, { paddingHorizontal: 0 }]}
                                                right={props => <Image style={{ position: 'absolute', right: -20, top: -35, transform: [{ rotate: "0deg" }] }}
                                                    source={require(imgPath + 'arrowDown_hg.png')} />}
                                            >
                                                <View style={[css.line5, css.spaceT20]}>
                                                    <View style={[css.flexDRSB]}>
                                                        <View>
                                                            <Text style={[css.f18, css.fm, css.brandC]}>Pricing</Text>
                                                        </View>
                                                        <Pressable
                                                            onPress={() => togglepricingDetailModal()}
                                                            style={[css.flexDR, css.alignSelfC]}
                                                        >
                                                            <AntDesign name="tagso" size={16} color="#2eb0e4" />
                                                            {/* <Image source={require(imgPath + 'tag.png')} /> */}
                                                            <Text style={[css.brandC, css.f14, css.fm]}>Pricing Details</Text>
                                                        </Pressable>
                                                    </View>
                                                </View>
                                                <View>
                                                ...
                                                <View>
                                                    ...
                                                    {jobdetailsData && jobdetailsData.payment.payment_type == 'CASH' && jobdetailsData.payment.actual_payment &&
                                                        <View style={[css.flexDRSB]}>
                                                            ...
                                                            <View><Text style={[css.alignSelfC, css.brandC, css.f12, css.fm]}>
                                                                ...
                                                                {jobdetailsData.payment.payment_type} ({jobdetailsData.payment.actual_payment ? jobdetailsData.payment.actual_payment.toFixed(2) : ''})
                                                            </Text></View>
                                                        </View>
                                                    }
                                                    <View style={[css.flexDRSB]}>
                                                ...
                                                <View style={[css.spaceT10, css.line5, css.paddingB20]}>
                                                    <View style={[css.flexDR]}>
                                                        <View style={[css.width30]}>
                                                            {/* <Image style={[css.marginR20, { width: 80, height: 70 }]} source={require(imgPath + 'warranty.png')} /> */}
                                                            <Image style={[css.marginR20, { width: wp('15%'), height: wp('15%') }]} source={require(imgPath + 'warranty.png')} />
                                                        </View>
                                                        <View style={[css.flexDC, css.alignSelfC]}>
                    ...
                    {jobdetailsData && jobdetailsData.accept && jobdetailsData.advancePayment && jobdetailsData.charges.advanceCharges == null &&
                                ...
                                <View style={[css.modalNewView, { marginTop: 20, marginBottom: 20 }]}>
                                    <View style={[css.modalNewHeader]}>
                                        <View
                                            style={[css.flexDR]}
                                        >
                                            <BackArrow onPress={() => setGenieModal(!genieModal)} text={null} />
                                                ...
                                                {genieData.feedback.latestComments ?
                                                    <View style={[css.padding10, css.line10]}>
                                                        ...
                                                        <View style={[css.flexDC, { flexWrap: 'wrap' }]}>
                                                            <Text style={[css.fm, css.f14, css.blackC, { lineHeight: 25 }]}>{genieData.feedback.latestComments > 0 ?
                                        ...
                                        <View style={[css.modalNewHeader,]}>
                                            ...
                                            <View>
                                                <View style={[css.flexDR, css.alignItemsC, css.justifyContentC]}>
                                                    {jobdetailsData.categoryImage.original ?
                                                        <Image
                            ...
                            <View style={css.centeredView}>
                                <View style={css.modalNewView}>
                                    <View style={[css.modalNewHeader]}>
                                        ...
                                        <View>
                                            <Text style={[css.modalNewText, css.f14, css.blackC, css.fm]}>Are you sure you want to reject the payment?</Text>
                                        </View>
                                    </View>
                                    <View style={[css.modalNewBody, css.alignItemsC, css.paddingT0]}>
                                        <View style={[css.flexDRSA, css.alignItemsC, css.imgFull, css.alignItemsC]}>
